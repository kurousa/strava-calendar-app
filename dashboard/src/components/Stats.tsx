...
export function DetailStat({ label, value, unit }: { label: string, value: string | number | undefined, unit: string }) {
  return (
    <div>
...
export function MetricRow({ icon, label, value, unit }: { icon: ReactNode, label: string, value: string | number | undefined, unit: string }) {
  return (
...
export function MetaStat({ icon, label, value, unit }: { icon: ReactNode, label: string, value: string, unit: string }) {
  return (
