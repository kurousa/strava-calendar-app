...
// 共通のメトリクス計算
// ==========================================
function getCommonMetrics(activity: StravaActivity): CommonMetrics {
    return {
...
// 汎用 (その他) のフォーマット処理
// ==========================================
function makeDefaultDescription(activity: StravaActivity): string {
...
let ACTIVITY_STYLES_CACHE: Readonly<Record<string, ActivityStyle>> | null = null;
...
// ==========================================
function makeDescription(activity: StravaActivity): string {
